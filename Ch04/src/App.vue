<template>
  ...
  <HooksComponent1 v-if="isShow"></HooksComponent1>
...
/*
    ...
    Vue3 Composition API
     - 기존 Option API를 대체하는 통합한 Composition API
...
import HooksComponent1 from "./components/sub3/HooksComponent1.vue";
